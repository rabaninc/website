...
// also closes the home page. The page closes with --gutter, not
// --content-gap: the card keeps the same distance to the page card's bottom
// edge as to its sides (as on / and /product).
